...
ggsave(
  filename = paste0(analysis_dir, "figs/ggsave_HIC_patient_control_panel_annotated", ".tiff"),
  plot = group_panel_ann,
  height = 15,
  width = 14,
  unit = "in",
...
ggsave(
  filename = paste0(analysis_dir, "figs/ggsave_HIC_patient_control_panel_annotated", ".pdf"),
  plot = group_panel_ann,
  height = 15,
  width = 14,
  unit = "in",
